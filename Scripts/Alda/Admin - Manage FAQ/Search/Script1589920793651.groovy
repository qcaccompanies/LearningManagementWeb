...
WebUI.click(findTestObject('Alda/Admin - Manage FAQ/Page_Manage Faq/click_search'))
...
if (expected_output == 'found') {
    WebUI.verifyElementNotVisible(findTestObject('Alda/Admin - Manage FAQ/Page_Manage Faq/alert_searching_not_found'))
} else if (expected_output == 'not found') {
    WebUI.verifyElementVisible(findTestObject('Alda/Admin - Manage FAQ/Page_Manage Faq/alert_searching_not_found'))
}
