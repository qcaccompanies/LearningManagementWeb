...
if (found == 'yes') {
    ...
    WebUI.verifyElementPresent(findTestObject('Christi/Page_Online Learning Detail/label_active_module', [('text') : module_name]), 
        0)

    if (status == 'new') {
        WebUI.verifyElementPresent(findTestObject('Christi/Page_Online Learning Detail/button_Mulai Modul'), 0)
    }
} else if (found == 'no') {
