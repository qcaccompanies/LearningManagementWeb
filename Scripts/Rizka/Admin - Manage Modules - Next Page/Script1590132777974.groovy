...
WebUI.scrollToElement(findTestObject('Rizka/Admin - Manage Modules - Next Page/btnNextPage'), 0)

WebUI.delay(5)

WebUI.click(findTestObject('Rizka/Admin - Manage Modules - Next Page/btnNextPage'))

WebUI.verifyElementClickable(findTestObject('Rizka/Admin - Manage Modules - Next Page/btnPreviousPage'))
