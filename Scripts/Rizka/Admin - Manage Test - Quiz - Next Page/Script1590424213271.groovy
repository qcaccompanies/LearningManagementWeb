...
WebUI.scrollToElement(findTestObject('Rizka/Admin - Manage Test - Quiz - Next Page/btnFirstPage'), 0)

WebUI.delay(5)

WebUI.click(findTestObject('Rizka/Admin - Manage Test - Quiz - Next Page/btnNext'))

WebUI.verifyElementClickable(findTestObject('Rizka/Admin - Manage Test - Quiz - Next Page/btnPrevious'))
